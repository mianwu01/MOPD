...
Outputs:
  - logs/iter2_baseline_summary.md  — markdown table for paper
  - logs/iter2_baseline_summary.csv — raw data for plotting
"""
import re, json, os
from pathlib import Path

LOG = "/home/ubuntu/MOPD/logs/iter2_full_v5b.log"
OUT_MD = "/home/ubuntu/MOPD/logs/iter2_baseline_summary.md"
OUT_CSV = "/home/ubuntu/MOPD/logs/iter2_baseline_summary.csv"
...
def main():
    ...
    with open(OUT_MD, "w") as f:
        f.write("# Iter2 5-teacher × 5-domain baseline (v5b stratified bs=320)\n\n")
