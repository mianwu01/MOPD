...
# Native GRPO: KL loss enabled (regularization via KL instead of asymmetric clipping)
use_kl_loss=True
...
# ============================================================================
# Launch native GRPO training
# ============================================================================

echo "Starting native GRPO training..."
...
echo ""
echo "=== Native GRPO training completed ==="
